 ...
 */
public class DikeJsonUtilClient {
  ...
  static HdfsFileStatus toFileStatus(final Map<?, ?> json,
    ...
    final DikeHdfsConstants.PathType type =
        DikeHdfsConstants.PathType.valueOf((String) m.get("type"));
    final byte[] symlink = type != DikeHdfsConstants.PathType.SYMLINK? null
    ...
    return new HdfsFileStatus.Builder()
      .length(len)
      .isdir(type == DikeHdfsConstants.PathType.DIRECTORY)
  ...
  static HdfsFileStatus[] toHdfsFileStatusArray(final Map<?, ?> json) {
    ...
    final List<?> array = DikeJsonUtilClient.getList(rootmap,
    ...
    for (Object object : array) {
      ...
      statuses[i++] = DikeJsonUtilClient.toFileStatus(m, false);
    }
    return statuses;
  }
