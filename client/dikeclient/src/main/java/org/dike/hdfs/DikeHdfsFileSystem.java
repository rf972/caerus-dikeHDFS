...
public class DikeHdfsFileSystem extends FileSystem
  ...
  //public static final String PATH_PREFIX = "/" + DikeHdfsConstants.DIKEHDFS_SCHEME + "/v" + VERSION;
  ...
  public String getScheme() {
    return DikeHdfsConstants.DIKEHDFS_SCHEME;
  }
  ...
  protected Text getTokenKind() {
    return DikeHdfsConstants.WEBHDFS_TOKEN_KIND;
  }
